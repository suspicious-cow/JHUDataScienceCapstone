...
preliminary on data with and without stopwords for comparison. 

## Data Sample Files Validation
Our tovalidate our sample files we used bootstrapping, a statistical resampling 
method, to understand the distribution of unique words in three types of 
...
The shape of these histograms can tell us a lot. For example, the histogram for 
